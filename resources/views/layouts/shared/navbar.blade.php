    ...
    <div class="flex items-center justify-between gap-4">
      <ul class="flex items-center justify-end gap-4">
        <li class="menu-item flex">
          <a class="text-xs font-medium text-default-700 transition-all hover:text-primary" href="" target="_blank">Seller Center</a>
        </li>
  ...
  <nav class="container flex h-16 items-center justify-between gap-4">
    ...
    <div class="relative mx-auto hidden flex-grow lg:block">
      <ul class="menu flex items-center justify-center">
        ...
        <li class="menu-item">
          <div class="hs-dropdown relative inline-flex [--trigger:hover]">
            ...
            <div class="hs-dropdown-menu z-10 hidden min-w-48 rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
              <ul class="flex flex-col gap-1">
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Home One</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Home Two</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <li class="menu-item">
          <div class="hs-dropdown relative inline-flex [--placement:bottom] [--trigger:hover]">
            ...
            <div class="hs-dropdown-menu z-10 mt-4 hidden min-w-[200px] rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
              <ul class="flex flex-col gap-1">
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Products Grid</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Products List</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Product Details</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Product Filter</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <li class="menu-item">
          <div class="hs-dropdown relative inline-flex [--placement:bottom] [--trigger:hover]">
            ...
            <div class="hs-dropdown-menu z-10 mt-4 hidden min-w-[200px] rounded-lg border border-default-100 bg-white p-1.5 opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
              <ul class="flex flex-col gap-1">
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Account Profile</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Cart</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Checkout</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Wishlist</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">FAQs</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Error 404</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Login</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Register</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Forgot Password</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Reset Password</a>
                </li>
                <li>
                  <a class="flex items-center rounded px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="">Logout</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <li class="menu-item">
          <div class="flex items-center">
            <a class="inline-flex items-center rounded-full px-4 py-2 text-sm font-medium text-default-700 hover:text-primary lg:text-base" href="">Contact Us</a>
          </div>
        </li>
      </ul>
    </div>
    ...
    <ul class="flex items-center justify-center gap-4">
      ...
      <li class="menu-item flex">
        <a href="{{ url('cart') }}" class="relative inline-flex h-10 w-10 flex-shrink-0 items-center justify-center gap-2 rounded-full bg-default-100 align-middle font-medium text-default-700 transition-all hover:text-primary">
          <i class="ti ti-shopping-bag text-xl"></i>
        </a>
      </li>

      <li class="menu-item hidden lg:flex">
        <a href="" class="relative inline-flex h-10 w-10 flex-shrink-0 items-center justify-center gap-2 rounded-full bg-default-100 align-middle font-medium text-default-700 transition-all hover:text-primary">
        ...
        <div class="hs-dropdown relative inline-flex [--placement:bottom-right] [--trigger:hover]">
          ...
          <div class="hs-dropdown-menu z-10 mt-4 hidden min-w-[200px] overflow-hidden rounded-lg border border-default-100 bg-white pb-1.5 opacity-0 shadow transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
            <ul class="flex flex-col gap-1">
              ...
              <li class="px-1.5">
                <a class="flex items-center rounded-md px-3 py-2 font-normal text-default-600 transition-all hover:bg-default-100 hover:text-default-700" href="" target="_blank"><i class="ti ti-dashboard me-2 text-lg"></i> Become a
                  Seller</a>
              </li>
              <li class="px-1.5">
      ...
      <ul class="admin-menu flex w-full flex-col gap-1.5">
        ...
        <li class="menu-item hs-accordion">
          ...
          <div class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300">
            <ul class="mt-2 flex flex-col gap-2">
              <li class="menu-item">
                <a class="flex items-center gap-x-3.5 rounded-full px-5 py-2 text-sm font-medium text-default-700 hover:bg-default-100" href="">
                  <i class="ti ti-circle-filled scale-[.25] text-lg"></i>
                  Products Grid
                </a>
              </li>
        ...
        <li class="menu-item">
          <a class="flex items-center gap-x-3.5 rounded-full px-5 py-3 text-sm font-medium text-default-700 transition-all hover:bg-default-100 hs-collapse-open:bg-default-100" href="">
