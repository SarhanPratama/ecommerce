    ...
    <section
        ...
        <div
                ...
                <form method="POST" action="{{ route('login') }}" class="shrink mt-10">
                    ...
                    <div class="mb-4">
                        <label for="LogInEmailAddress"
                            class="block text-base/normal font-semibold text-default-800 mb-2">Email
                            address</label>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex" data-x-password="">
                            <input data-x-field="password" name="password" type="password"
                                id="form-password"
            ...
            <p class="shrink text-default-600 font-medium text-center mt-4">Don't have an account? <a
                    href=""
                    class="text-primary font-semibold ms-1">Register</a>
            </p>
        </div>
    </section>
